...
architecture src of cos_table_gen is
  ...
  constant cosine_table_unsigned : cosine_table_type :=
  (
    "1111001", -- 123
    "1111001",
    "1111001",
  ...
  constant cosine_table_signed : cosine_table_type :=
  (
    "0111001",
    "0111001",
    "0111001",
  ...
  signal cosine_value_unsigned : std_logic_vector(6 downto 0);
  signal cosine_value_signed   : std_logic_vector(6 downto 0);

begin

  read_table : process (clk, reset, angle) is
  begin
    ...
    if (reset = '1') then
      ...
      angle_reg             <= angle;
      cosine_value_unsigned <= cosine_table_unsigned(to_integer(unsigned(angle_reg)));
      cosine_value_signed   <= cosine_table_signed(to_integer(unsigned(angle_reg)));
    end if;

  end process read_table;

  cosine_out_unsigned <= cosine_value_unsigned;
  cosine_out_signed   <= cosine_value_signed;

  angle_generator : process (clk, angle) is
