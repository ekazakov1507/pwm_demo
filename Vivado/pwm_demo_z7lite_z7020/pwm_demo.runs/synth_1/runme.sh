...
HD_PWD='C:/Users/user/VivadoProjects/2018-3/pwm_demo/Vivado/pwm_demo_z7lite_z7020/pwm_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_platform.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_platform.tcl
