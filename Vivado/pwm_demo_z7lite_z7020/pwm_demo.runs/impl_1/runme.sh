...
HD_PWD='C:/Users/user/VivadoProjects/2018-3/pwm_demo/Vivado/pwm_demo_z7lite_z7020/pwm_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_platform.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_platform.tcl -notrace
