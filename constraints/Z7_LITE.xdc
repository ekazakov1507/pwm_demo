...
set_property -dict { PACKAGE_PIN N17 IOSTANDARD LVCMOS33 } [get_ports { sys_pwm[0] }];
set_property -dict { PACKAGE_PIN P18 IOSTANDARD LVCMOS33 } [get_ports { sys_pwm_n[0] }];
set_property -dict { PACKAGE_PIN R16 IOSTANDARD LVCMOS33 } [get_ports { sys_pwm[1] }];
set_property -dict { PACKAGE_PIN R17 IOSTANDARD LVCMOS33 } [get_ports { sys_pwm_n[1] }];
set_property -dict { PACKAGE_PIN T16 IOSTANDARD LVCMOS33 } [get_ports { sys_pwm[2] }];
set_property -dict { PACKAGE_PIN U17 IOSTANDARD LVCMOS33 } [get_ports { sys_pwm_n[2] }];
set_property -dict { PACKAGE_PIN W18 IOSTANDARD LVCMOS33 } [get_ports { sys_pwm[3] }];
set_property -dict { PACKAGE_PIN W19 IOSTANDARD LVCMOS33 } [get_ports { sys_pwm_n[3] }];
...
# set_property PACKAGE_PIN N17 [get_ports GPI01_OP]
# set_property PACKAGE_PIN P18 [get_ports GPI01_ON]
# set_property PACKAGE_PIN R16 [get_ports GPI01_1P]
# set_property PACKAGE_PIN R17 [get_ports GPI01_1N]
# set_property PACKAGE_PIN T16 [get_ports GPI01_2P]
# set_property PACKAGE_PIN U17 [get_ports GPIO1_2N]
# set_property PACKAGE_PIN W18 [get_ports GPI01_3P]
# set_property PACKAGE_PIN W19 [get_ports GPI01_3N]
...
# set_property PACKAGE_PIN T12 [get_ports GPI01_17P]
# set_property PACKAGE_PIN U12 [get_ports GPIO1_17N]

# set_property IOSTANDARD LVCMOS33 [get_ports GPI01_OP]
...
# set_property IOSTANDARD LVCMOS33 [get_ports GPI00_17P]
